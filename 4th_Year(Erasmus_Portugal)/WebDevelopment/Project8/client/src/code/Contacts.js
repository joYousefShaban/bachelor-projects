            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].get("".concat(config_1.config.serverAddress, "/contacts"))];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].post("".concat(config_1.config.serverAddress, "/contacts"), inContact)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"]["delete"]("".concat(config_1.config.serverAddress, "/contacts/").concat(inID))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
