...
// App imports.
var BaseLayout_1 = __importDefault(require("./components/BaseLayout"));
var IMAP = __importStar(require("./IMAP"));
var Contacts = __importStar(require("./Contacts"));
// Render the UI.
var baseComponent = react_dom_1["default"].render(react_1["default"].createElement(BaseLayout_1["default"], null), document.body);
// Now go fetch the user's mailboxes, and then their contacts.
baseComponent.state.showHidePleaseWait(true);
function getMailboxes() {
    return __awaiter(this, void 0, void 0, function () {
        var imapWorker, mailboxes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    mailboxes = _a.sent();
                    mailboxes.forEach(function (inMailbox) {
...
getMailboxes().then(function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        contacts = _a.sent();
                        contacts.forEach(function (inContact) {
    ...
    getContacts().then(function () { return baseComponent.state.showHidePleaseWait(false); });
});
