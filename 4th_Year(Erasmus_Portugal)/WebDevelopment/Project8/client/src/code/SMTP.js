...
var Worker = /** @class */ (function () {
     ...
     */
    Worker.prototype.sendMessage = function (inTo, inFrom, inSubject, inMessage) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("SMTP.Worker.sendMessage()");
                        return [4 /*yield*/, axios_1["default"].post("".concat(config_1.config.serverAddress, "/messages"), { to: inTo, from: inFrom, subject: inSubject,
                                text: inMessage
                            })];
                    case 1:
                        _a.sent();
